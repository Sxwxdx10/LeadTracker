...
namespace LeadTracker.Infrastructure.Migrations
{
    ...
    [Migration("20251125085959_IncreaseTimeZoneLength")]
    partial class IncreaseTimeZoneLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeadTracker.Core.Entities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeadTracker.Core.Entities.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeadTracker.Core.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeadTracker.Core.Entities.ImportHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeadTracker.Core.Entities.Attachment", b =>
                {
                    b.HasOne("LeadTracker.Core.Entities.Activity", "Activity")
                        .WithMany("Attachments")
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LeadTracker.Core.Entities.Comment", "Comment")
                        .WithMany("Attachments")
                    ...
                    b.HasOne("LeadTracker.Core.Entities.Task", "Task")
                        .WithMany()
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LeadTracker.Core.Entities.User", "UploadedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LeadTracker.Core.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("LeadTracker.Core.Entities.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("LeadTracker.Core.Entities.ImportHistory", b =>
                {
                    b.HasOne("LeadTracker.Core.Entities.User", "ImportedByUser")
                        .WithMany()
